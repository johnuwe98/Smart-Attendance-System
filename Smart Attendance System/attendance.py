...
# Initialize Firebase (run this in BOTH scripts)
cred = credentials.Certificate("C:\Smart Attendance System\key.json")
...
logo = Image.open("UI_Image/uniuyologo.png")
logo = logo.resize((70, 60), Image.LANCZOS)
logo1 = ImageTk.PhotoImage(logo)
titl = tk.Label(window, bg="#1c1c1c", relief=RIDGE, bd=10, font=("Verdana", 40, "bold"))
titl.pack(fill=X)
...
titl = tk.Label(
    window, text="SMART ATTENDANCE SYSTEM", bg="#1c1c1c", fg="yellow", font=("Verdana", 35, "bold"),
)
titl.place(x=300, y=10)

a = tk.Label(
    window,
    text="WELCOME TO UNIVERSITY OF UYO CLASS VISION",
...
def TakeImageUI():
    ...
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="#1c1c1c", fg="white", font=("Verdana", 25, "bold"),
    )
    titl.place(x=230, y=12)
